...
RunRep(200, 50, 20, 0.10, 1, 25);
RunRep(500,  50, 20, 0.10, 1, 25);
RunRep(1000, 50, 20, 0.10, 1, 25);
RunRep(1500, 50, 20, 0.10, 1, 25);
RunRep(2000, 50, 20, 0.10, 1, 25);
%%
RunRep(1000, 50, 10, 0.10, 1, 25);
RunRep(1000, 50, 15, 0.10, 1, 25);
RunRep(1000, 50, 25, 0.10, 1, 25);
RunRep(1000, 50, 30, 0.10, 1, 25);
%% 
RunRep(1000, 50, 20, 0.05, 1, 25);
RunRep(1000, 50, 20, 0.15, 1, 25);
RunRep(1000, 50, 20, 0.20, 1, 25);
RunRep(1000, 50, 20, 0.25, 1, 25);
%% 
...
%         Lu = max(Dsq) * 2;
%         Lu = 8/dx^2.*(sin(pi/4))^2 + V;
%         Lu = 2*abs(eigs(full(A),1));
%         eigopts.maxit = 100000;
%         Lu = 2*abs(eigs(A,1,'lm',eigopts));
        tol = 5e-5;
        maxiter = 30000;
