...
RunRep(500,  50, 20, 1.00, 1, 25);
RunRep(1000, 50, 20, 1.00, 1, 25);
RunRep(1500, 50, 20, 1.00, 1, 25);
RunRep(2000, 50, 20, 1.00, 1, 25);
RunRep(2500, 50, 20, 1.00, 1, 25);
RunRep(3000, 50, 20, 1.00, 1, 25);
%%
RunRep(2000, 50, 5,  1.00, 1, 25);
RunRep(2000, 50, 10, 1.00, 1, 25);
RunRep(2000, 50, 15, 1.00, 1, 25);
RunRep(2000, 50, 25, 1.00, 1, 25);
%%
RunRep(2000, 50, 20, 0.25, 1, 25);
RunRep(2000, 50, 20, 0.50, 1, 25);
RunRep(2000, 50, 20, 0.75, 1, 25);
RunRep(2000, 50, 20, 1.25, 1, 25);
...
%         RPMWHtol = 1e-3;
        ...
        [X_arpg, maxit_att_arpg, time_arpg, F_arpg, nD5, sparsity5, avar5,time_arr_arpg,obj_arr_arpg,gx_arr_arpg] = ARPG_SPCA(Xinitial, A, lambda, Ll, Lu, tol, maxiter,  F_tol, RPMWHmaxiter, RPMWHtol);
        T7 = [T7; time_arpg];
        F7 = [F7; F_arpg];
        S7 = [S7; sparsity5 * 100];
